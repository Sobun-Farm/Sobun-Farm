	...
	<main>
		<div class="container">
            ...
            <div class="chat-content">
            	...
            	<h3>${param.itemTitle} - ${param.itemName}</h3> <!-- itemTitle과 itemName을 표시 -->
                ...
                <div class="messages_input">
				    <form action="${pageContext.request.contextPath}/chatContent" method="post" target="chatListFrame">
				        ...
				        <textarea name="messageContent" placeholder="메시지를 입력하세요" required></textarea>
				        <button type="submit">전송</button>
				    </form>
				</div>
				
				<div>
					<button onclick="exitChat()">채팅방 나가기2</button> <!-- 채팅방 나가기 버튼 -->
				</div>
