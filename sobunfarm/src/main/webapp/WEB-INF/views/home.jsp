    ...
    <main>
       <div class="filter-container">
        <div class="region-filter">
          <label for="region">
            <img src="image/region.png" alt="구 선택" class="label-icon">
          </label>
          ...
          <label for="drop-down">
            <img src="image/arrow_drop_down.png" alt="드롭다운" class="label-icon">
          </label>
        </div>
      ...
      <%
       ...
       %>
         <a href="<%=request.getContextPath()%>/detail.jsp" class="product-card">
