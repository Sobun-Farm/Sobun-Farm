   ...
   <main>
      <div class="filter-container">
         <div class="region-filter">
            <label for="region">
               <!-- 이미지 경로 수정 -->
               <img src="<%=request.getContextPath()%>/image/region.png" alt="구 선택" class="label-icon">
            </label>
            ...
            <label for="drop-down">
               <!-- 이미지 경로 수정 -->
               <img src="<%=request.getContextPath()%>/image/arrow_drop_down.png" alt="드롭다운" class="label-icon">
            </label>
         </div>
