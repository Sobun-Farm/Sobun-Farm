    ...
    <div class="container">
        ...
        <div class="profile-section">
            <div class="profile-image">
				<img id="profileImage" src="data:image/jpeg;base64, <%= base64Image %>"  alt="프로필 이미지" onclick="showImageUploadPopup()">
                <h2>${nickname}</h2>
            ...
            <div class="profile-info">
                ...
                <div class="stats">
                    ...
                    <span>${successfulTransaction}</span>
                    <button class="btn btn-progress">진행 소분 수</button>
                    <span>${result}</span>
                </div>
                <form action="updateDescription" method="post">
				    <textarea class="description" name="text" spellcheck="false"><%= (String) session.getAttribute("text") %></textarea>
