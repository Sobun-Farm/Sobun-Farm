...
<body>
	<header>
        ...
        <div class="user">
            <span><a href="#${pageContext.request.contextPath}/MainPage.jsp"><img src="${pageContext.request.contextPath}/images/user.png" alt="user"></a></span>
        </div>
        <div class="login">
		    <% 
		        // 세션에서 로그인된 사용자 정보 확인
    ...
    <main>
	    ...
	    %>
	      <div class="product-card">
	        <img src="${pageContext.request.contextPath}/images/example.png" alt="상품 이미지 <%=i%>">
	        <h3>상품 제목 <%=i%></h3>
	        <p><%= i * 1000 %>원/명</p>
